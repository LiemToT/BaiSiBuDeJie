...
- (void)awakeFromNib
{
    ...
    self.player.allowsAirPlayVideo = true;
...
- (IBAction)switchOrientation:(UIButton *)sender {
//    sender.selected = !sender.selected;
    self.playOrPauseBtn.selected = false;
//    AVPlayerItem *playerItem = [AVPlayerItem playerItemWithURL:[NSURL URLWithString:self.topic.videouri]];
